  ...
  return (
    <section className={ctaStyles.root()} aria-labelledby="invite-title">
      ...
      <div className={ctaStyles.inner()}>
        ...
        <ButtonLink href={siteConfig.inviteUrl} target="_blank" rel="noreferrer" className="shrink-0 border-ink bg-ink px-7 text-bone hover:border-alarm hover:bg-alarm hover:text-white">
